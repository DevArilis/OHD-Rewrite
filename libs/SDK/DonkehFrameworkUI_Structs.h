...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IP9R[0x5];                                   // 0x000B(0x0005) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_N73C[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MG3H[0x7];                                   // 0x0129(0x0007) MISSED OFFSET (PADDING)
	};
