...
namespace CG
{
	 ...
	 */
	struct UWBP_DlgBox_Quit_C_OnMouseButtonDown_Params
	{
	public:
	 ...
	 */
	struct UWBP_DlgBox_Quit_C_Construct_Params
	{	};

	/**
	 * Function WBP_DlgBox_Quit.WBP_DlgBox_Quit_C.BndEvt__YesBtn_K2Node_ComponentBoundEvent_2_ButtonClicked__DelegateSignature
	 */
	struct UWBP_DlgBox_Quit_C_BndEvt__YesBtn_K2Node_ComponentBoundEvent_2_ButtonClicked__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UWBP_DlgBox_Quit_C_BndEvt__NoBtn_K2Node_ComponentBoundEvent_3_ButtonClicked__DelegateSignature_Params
	{
	public:
		class UWBP_DialogBox_Button_C*                             ClickedBtn;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UWBP_DlgBox_Quit_C_DummyInput_Params
	{	};

	/**
	 * Function WBP_DlgBox_Quit.WBP_DlgBox_Quit_C.ExecuteUbergraph_WBP_DlgBox_Quit
	 */
	struct UWBP_DlgBox_Quit_C_ExecuteUbergraph_WBP_DlgBox_Quit_Params
	{
	public:
