...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9E2G[0x2];                                   // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_KEGU[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		float                                                      ReturnValue;                                             // 0x000C(0x0004)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UABP_HDPlayerCharacter_TP_C_IKFootTraceSetup_Params
	{
	public:
	 ...
	 */
	struct UABP_HDPlayerCharacter_TP_C_GetCapsuleQuarterHeight_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_KJS5[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_8XJI[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_GNCM[0x7];                                   // 0x0129(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FPCI[0xF];                                   // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		EItemType                                                  ItemType;                                                // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_IKQX[0xF];                                   // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UABP_HDPlayerCharacter_TP_C_AnimNotify_EnterVaultState_Params
	{	};

	/**
	 * Function ABP_HDPlayerCharacter_TP.ABP_HDPlayerCharacter_TP_C.AnimNotify_LeftVaultState
	 */
	struct UABP_HDPlayerCharacter_TP_C_AnimNotify_LeftVaultState_Params
	{	};
