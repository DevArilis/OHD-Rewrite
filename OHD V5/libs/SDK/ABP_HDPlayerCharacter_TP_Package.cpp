...
namespace CG
{
	 ...
	 */
	void UABP_HDPlayerCharacter_TP_C::IKFootTraceSetup(const class FName& SocketName, struct FVector* TraceStart, struct FVector* TraceEnd)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ABP_HDPlayerCharacter_TP.ABP_HDPlayerCharacter_TP_C.IKFootTraceSetup");
		
		UABP_HDPlayerCharacter_TP_C_IKFootTraceSetup_Params params {};
	...
	void UABP_HDPlayerCharacter_TP_C::GetCapsuleQuarterHeight(class ACharacter* Char)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ABP_HDPlayerCharacter_TP.ABP_HDPlayerCharacter_TP_C.GetCapsuleQuarterHeight");
		
		UABP_HDPlayerCharacter_TP_C_GetCapsuleQuarterHeight_Params params {};
		params.Char = Char;
	...
	void UABP_HDPlayerCharacter_TP_C::AnimNotify_EnterVaultState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ABP_HDPlayerCharacter_TP.ABP_HDPlayerCharacter_TP_C.AnimNotify_EnterVaultState");
		
		UABP_HDPlayerCharacter_TP_C_AnimNotify_EnterVaultState_Params params {};
	...
	void UABP_HDPlayerCharacter_TP_C::AnimNotify_LeftVaultState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ABP_HDPlayerCharacter_TP.ABP_HDPlayerCharacter_TP_C.AnimNotify_LeftVaultState");
		
		UABP_HDPlayerCharacter_TP_C_AnimNotify_LeftVaultState_Params params {};
