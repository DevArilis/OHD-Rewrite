...
namespace CG
{
	...
	bool ABP_HDHUDBase_C::NametagsSingleLinetrace(const struct FVector& Start, const struct FVector& End, class ABP_HDPlayerCharacterBase_C* OtherPlayer)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDHUDBase.BP_HDHUDBase_C.NametagsSingleLinetrace");
		
		ABP_HDHUDBase_C_NametagsSingleLinetrace_Params params {};
		params.Start = Start;
		params.End = End;
	...
	void ABP_HDHUDBase_C::CanDrawNametag(class ABP_HDPlayerCharacterBase_C* InOtherPawn, float InVerticalOffset, const struct FVector& InOwnerCameraLocation, bool* bCanDrawNametag, struct FVector2D* NametagScreenPosition)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDHUDBase.BP_HDHUDBase_C.CanDrawNametag");
		
		ABP_HDHUDBase_C_CanDrawNametag_Params params {};
		params.InOtherPawn = InOtherPawn;
		params.InVerticalOffset = InVerticalOffset;
		params.InOwnerCameraLocation = InOwnerCameraLocation;
		...
		if (bCanDrawNametag != nullptr)
			*bCanDrawNametag = params.bCanDrawNametag;
		if (NametagScreenPosition != nullptr)
			*NametagScreenPosition = params.NametagScreenPosition;
	}
	 ...
	 */
	void ABP_HDHUDBase_C::DrawNametags(int32_t SizeX, int32_t SizeY)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDHUDBase.BP_HDHUDBase_C.DrawNametags");
		
		ABP_HDHUDBase_C_DrawNametags_Params params {};
		params.SizeX = SizeX;
		params.SizeY = SizeY;
	 ...
	 * 		int32_t                                            SizeY                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_HDHUDBase_C::DrawCrosshair(int32_t SizeX, int32_t SizeY)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDHUDBase.BP_HDHUDBase_C.DrawCrosshair");
		
		ABP_HDHUDBase_C_DrawCrosshair_Params params {};
		params.SizeX = SizeX;
		params.SizeY = SizeY;
