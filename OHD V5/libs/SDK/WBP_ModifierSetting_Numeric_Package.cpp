...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function WBP_ModifierSetting_Numeric.WBP_ModifierSetting_Numeric_C.GetValueSnapDelta
	...
	void UWBP_ModifierSetting_Numeric_C::GetValueSnapDelta(float* Delta)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WBP_ModifierSetting_Numeric.WBP_ModifierSetting_Numeric_C.GetValueSnapDelta");
		
		UWBP_ModifierSetting_Numeric_C_GetValueSnapDelta_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function WBP_ModifierSetting_Numeric.WBP_ModifierSetting_Numeric_C.SetValueSnapDelta
	...
	void UWBP_ModifierSetting_Numeric_C::SetValueSnapDelta(float InDelta)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WBP_ModifierSetting_Numeric.WBP_ModifierSetting_Numeric_C.SetValueSnapDelta");
		
		UWBP_ModifierSetting_Numeric_C_SetValueSnapDelta_Params params {};
