...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function BP_HDAIControllerBase.BP_HDAIControllerBase_C.RestorePreviousValuesForWeapon
	 * 		Flags  -> (Protected, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		class ABP_HDWeaponBase_C*                          Weapon                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_HDAIControllerBase_C::RestorePreviousValuesForWeapon(class ABP_HDWeaponBase_C* Weapon)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDAIControllerBase.BP_HDAIControllerBase_C.RestorePreviousValuesForWeapon");
		
		ABP_HDAIControllerBase_C_RestorePreviousValuesForWeapon_Params params {};
		params.Weapon = Weapon;
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function BP_HDAIControllerBase.BP_HDAIControllerBase_C.SaveAndApplyNewValuesToWeapon
	 * 		Flags  -> (Protected, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	 * 		class ABP_HDWeaponBase_C*                          Weapon                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_HDAIControllerBase_C::SaveAndApplyNewValuesToWeapon(class ABP_HDWeaponBase_C* Weapon)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDAIControllerBase.BP_HDAIControllerBase_C.SaveAndApplyNewValuesToWeapon");
		
		ABP_HDAIControllerBase_C_SaveAndApplyNewValuesToWeapon_Params params {};
		params.Weapon = Weapon;
