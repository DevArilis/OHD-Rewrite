...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_EWU8[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABP_HDPlayerControllerBase_C_RestoreCamDefaultViewRotationYawLimits_Params
	{	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.RestoreCamDefaultViewRotationPitchLimits
	 */
	struct ABP_HDPlayerControllerBase_C_RestoreCamDefaultViewRotationPitchLimits_Params
	{	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.RestoreCamDefaultViewRotationRollLimits
	 */
	struct ABP_HDPlayerControllerBase_C_RestoreCamDefaultViewRotationRollLimits_Params
	{	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.RestoreCamDefaultViewRotationLimits
	 */
	struct ABP_HDPlayerControllerBase_C_RestoreCamDefaultViewRotationLimits_Params
	{	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.SetCamViewRotationYawLimits
	 */
	struct ABP_HDPlayerControllerBase_C_SetCamViewRotationYawLimits_Params
	{
	public:
		...
		unsigned char                                              UnknownData_5LJX[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.SetCamViewRotationPitchLimits
	 */
	struct ABP_HDPlayerControllerBase_C_SetCamViewRotationPitchLimits_Params
	{
	public:
		...
		bool                                                       bRelativeToPawnRotation;                                 // 0x0008(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_MFTF[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.SetCamViewRotationRollLimits
	 */
	struct ABP_HDPlayerControllerBase_C_SetCamViewRotationRollLimits_Params
	{
	public:
		...
		bool                                                       bRelativeToPawnRotation;                                 // 0x0008(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_V6BB[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function BP_HDPlayerControllerBase.BP_HDPlayerControllerBase_C.SetCamViewRotationLimits
	 */
	struct ABP_HDPlayerControllerBase_C_SetCamViewRotationLimits_Params
	{
	public:
		struct FRotator                                            ViewRotMin;                                              // 0x0000(0x000C)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		struct FRotator                                            ViewRotMax;                                              // 0x000C(0x000C)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		...
		unsigned char                                              UnknownData_W041[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_LF8F[0x5];                                   // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	{
	public:
		unsigned char                                              UnknownData_BZTA[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct ABP_HDPlayerControllerBase_C_IsVictoryMenuShown_Params
	{
	public:
	 ...
	 */
	struct ABP_HDPlayerControllerBase_C_UpdatePlayerPOIs_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_SNIZ[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct ABP_HDPlayerControllerBase_C_ReceiveUnpossessPawn_Params
	{
	public:
