...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_K329[0x10];                                  // 0x0438(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       UnknownData_TDEH : 2;                                    // 0x0448(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                              UnknownData_IC7Z[0x17];                                  // 0x0449(0x0017) MISSED OFFSET (PADDING)
