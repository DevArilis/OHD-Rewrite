...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function WBP_GameModifierSettingsSection.WBP_GameModifierSettingsSection_C.OnDeactivated__DelegateSignature
	...
	void UWBP_GameModifierSettingsSection_C::OnDeactivated__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WBP_GameModifierSettingsSection.WBP_GameModifierSettingsSection_C.OnDeactivated__DelegateSignature");
		
		UWBP_GameModifierSettingsSection_C_OnDeactivated__DelegateSignature_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function WBP_GameModifierSettingsSection.WBP_GameModifierSettingsSection_C.OnActivated__DelegateSignature
	 * 		Flags  -> (Public, Delegate, BlueprintCallable, BlueprintEvent)
	 */
	void UWBP_GameModifierSettingsSection_C::OnActivated__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WBP_GameModifierSettingsSection.WBP_GameModifierSettingsSection_C.OnActivated__DelegateSignature");
		
		UWBP_GameModifierSettingsSection_C_OnActivated__DelegateSignature_Params params {};
