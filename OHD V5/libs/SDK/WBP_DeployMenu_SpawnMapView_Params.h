...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XD5P[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		unsigned char                                              UnknownData_2TUH[0x2F];                                  // 0x0001(0x002F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UWBP_DeployMenu_SpawnMapView_C_OnPreloadFinishedSpawnMapView_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_RIDY[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
