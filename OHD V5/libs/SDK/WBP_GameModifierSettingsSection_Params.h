...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UE76[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_1AUU[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_ZK3R[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function WBP_GameModifierSettingsSection.WBP_GameModifierSettingsSection_C.OnDeactivated__DelegateSignature
	 */
	struct UWBP_GameModifierSettingsSection_C_OnDeactivated__DelegateSignature_Params
	{	};

	/**
	 * Function WBP_GameModifierSettingsSection.WBP_GameModifierSettingsSection_C.OnActivated__DelegateSignature
	 */
	struct UWBP_GameModifierSettingsSection_C_OnActivated__DelegateSignature_Params
	{	};
