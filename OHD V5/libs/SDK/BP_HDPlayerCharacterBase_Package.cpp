...
namespace CG
{
	...
	void ABP_HDPlayerCharacterBase_C::IsSameSquad(class ABP_HDPlayerControllerBase_C* LocalController, bool* bSameSquad)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.IsSameSquad");
		
		ABP_HDPlayerCharacterBase_C_IsSameSquad_Params params {};
	...
	void ABP_HDPlayerCharacterBase_C::GetVaultCameraCurveForBehavior(EVaultBehavior VaultBehavior, class UCurveVector** CameraCurve)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.GetVaultCameraCurveForBehavior");
		
		ABP_HDPlayerCharacterBase_C_GetVaultCameraCurveForBehavior_Params params {};
		params.VaultBehavior = VaultBehavior;
		...
		if (CameraCurve != nullptr)
			*CameraCurve = params.CameraCurve;
	}
	...
	void ABP_HDPlayerCharacterBase_C::RestorePCViewRotationYawLimits()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.RestorePCViewRotationYawLimits");
		
		ABP_HDPlayerCharacterBase_C_RestorePCViewRotationYawLimits_Params params {};
	...
	void ABP_HDPlayerCharacterBase_C::SetPCViewRotationYawLimits(float ViewYawMin, float ViewYawMax, bool bRelativeToActorRotation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.SetPCViewRotationYawLimits");
		
		ABP_HDPlayerCharacterBase_C_SetPCViewRotationYawLimits_Params params {};
		params.ViewYawMin = ViewYawMin;
		params.ViewYawMax = ViewYawMax;
		params.bRelativeToActorRotation = bRelativeToActorRotation;
	 ...
	 */
	void ABP_HDPlayerCharacterBase_C::SelectEquipmentBySlotNum(int32_t EquipSlotNum, bool bEquipImmediately, bool bFromInput)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	...
	void ABP_HDPlayerCharacterBase_C::VaultCameraTimeline__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.VaultCameraTimeline__FinishedFunc");
		
		ABP_HDPlayerCharacterBase_C_VaultCameraTimeline__FinishedFunc_Params params {};
	...
	void ABP_HDPlayerCharacterBase_C::VaultCameraTimeline__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.VaultCameraTimeline__UpdateFunc");
		
		ABP_HDPlayerCharacterBase_C_VaultCameraTimeline__UpdateFunc_Params params {};
	 ...
	 * 		struct FKey                                        Key                                                        (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
	 */
	void ABP_HDPlayerCharacterBase_C::InpActEvt_CycleWeaponSights_K2Node_InputActionEvent_2(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.InpActEvt_CycleWeaponSights_K2Node_InputActionEvent_2");
		
		ABP_HDPlayerCharacterBase_C_InpActEvt_CycleWeaponSights_K2Node_InputActionEvent_2_Params params {};
		params.Key = Key;
	 ...
	 * 		struct FKey                                        Key                                                        (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
	 */
	void ABP_HDPlayerCharacterBase_C::InpActEvt_PointAimToggle_K2Node_InputActionEvent_1(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.InpActEvt_PointAimToggle_K2Node_InputActionEvent_1");
		
		ABP_HDPlayerCharacterBase_C_InpActEvt_PointAimToggle_K2Node_InputActionEvent_1_Params params {};
		params.Key = Key;
	 ...
	 */
	void ABP_HDPlayerCharacterBase_C::HitDamage(class ADFBaseProjectile* OtherProjectile, class ADFBasePickup* Pickup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.Hit Damage");
		
		ABP_HDPlayerCharacterBase_C_HitDamage_Params params {};
	...
	void ABP_HDPlayerCharacterBase_C::ReceiveHealthChanged(float NewHealthTotal, float PrevHealthTotal)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.ReceiveHealthChanged");
		
		ABP_HDPlayerCharacterBase_C_ReceiveHealthChanged_Params params {};
	...
	void ABP_HDPlayerCharacterBase_C::ReceiveOnStartVault()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.ReceiveOnStartVault");
		
		ABP_HDPlayerCharacterBase_C_ReceiveOnStartVault_Params params {};
	...
	void ABP_HDPlayerCharacterBase_C::ReceiveOnEndVault()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HDPlayerCharacterBase.BP_HDPlayerCharacterBase_C.ReceiveOnEndVault");
		
		ABP_HDPlayerCharacterBase_C_ReceiveOnEndVault_Params params {};
