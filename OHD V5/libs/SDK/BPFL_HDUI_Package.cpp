...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00EC0A10
	 * 		Name   -> Function BPFL_HDUI.BPFL_HDUI_C.ParseServerBadgesFromTable
	 ...
	 */
	void UBPFL_HDUI_C::STATIC_ParseServerBadgesFromTable(class UDataTable* BadgeTable, class UObject* __WorldContext, TArray<struct FFServerBadgeUIDefinition>* SortedBadgeDefs)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BPFL_HDUI.BPFL_HDUI_C.ParseServerBadgesFromTable");
		
		UBPFL_HDUI_C_ParseServerBadgesFromTable_Params params {};
		params.BadgeTable = BadgeTable;
		...
		if (SortedBadgeDefs != nullptr)
			*SortedBadgeDefs = params.SortedBadgeDefs;
	}
