...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DMZQ[0x60];                                  // 0x0220(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5CKQ[0x3];                                   // 0x0365(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8QEM[0x60];                                  // 0x00B0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_67E2[0x3];                                   // 0x01F5(0x0003) MISSED OFFSET (PADDING)
