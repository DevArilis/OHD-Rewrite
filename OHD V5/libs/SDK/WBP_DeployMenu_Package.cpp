...
namespace CG
{
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UWBP_DeployMenu_C::OnTeam1SwitchBtnClicked()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WBP_DeployMenu.WBP_DeployMenu_C.On Team 1 Switch Btn Clicked");
		
		UWBP_DeployMenu_C_OnTeam1SwitchBtnClicked_Params params {};
	 ...
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UWBP_DeployMenu_C::OnTeam0SwitchBtnClicked()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WBP_DeployMenu.WBP_DeployMenu_C.On Team 0 Switch Btn Clicked");
		
		UWBP_DeployMenu_C_OnTeam0SwitchBtnClicked_Params params {};
